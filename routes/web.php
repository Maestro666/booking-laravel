...
Route::group(['prefix'=>'admin','middleware'=>'auth'],function(){  /*'middleware'=>'auth' */
  ...
  Route::match(['GET','POST'],trans('routes.saveobject').'/{id?}','BackendController@saveObject')->name('saveObject'); /* match(['GET','POST'];/{id?} */
  Route::match(['GET','POST'],trans('routes.profile'),'BackendController@profile')->name('profile'); /* match(['GET','POST'] */
